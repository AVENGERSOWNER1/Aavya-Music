...
BOT_USERNAME = getenv("BOT_USERNAME" , "AavyaMusicBot")
BOT_NAME = getenv("BOT_NAME" , "˹𐓘αᴠʏᴀ ꭙ ᴍᴜsɪᴄ˼ ♪)
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/AVENGERSOWNER1/Aavya-Music",)
